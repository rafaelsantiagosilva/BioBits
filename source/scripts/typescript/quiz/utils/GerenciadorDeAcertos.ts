class GerenciadorDeAcertos {
    ...
    private CLASSES_RESPOSTA: string[] = ['acertou', 'intermediario', 'errou']!;

    private vitoria(pontuacao: number): void {
        this.iconeResposta.classList.add('bi-check-circle');
        this.avisoResposta?.classList.add(this.CLASSES_RESPOSTA[0]);
    ...
    private intermediario(pontuacao: number): void {
        ...
        this.avisoResposta?.classList.add(this.CLASSES_RESPOSTA[1]);
    ...
    private derrota(pontuacao: number): void {
        ...
        this.avisoResposta?.classList.add(this.CLASSES_RESPOSTA[2]);
